...
> ### ⚠️ 合理使用与免责声明
>
> - 本工具仅供 **个人学习、研究与存档** 使用，请勿用于任何商业用途或大规模批量抓取。
> - 使用本工具抓取内容时，请遵守目标平台（抖音 / B 站等）的**服务条款**、robots 协议及适用的**当地法律法规**。
> - 请尊重内容创作者版权：下载的视频/图文仅可用于个人收藏、学习分析等合理场景，**请勿二次分发或用于侵权用途**。
> - 本工具仅调用目标平台公开接口，不含任何破解、绕过付费或反爬对抗能力；因使用本工具产生的任何法律风险由使用者自行承担。
> - 详细第三方组件许可与合规说明见 [THIRD-PARTY-NOTICES](THIRD-PARTY-NOTICES.md)。
...
| ⏰ **主页订阅（v0.4.1）** | 订阅抖音用户主页，按设定间隔定时扫描；发现新作品后展示供你选择下载或跳过 |
